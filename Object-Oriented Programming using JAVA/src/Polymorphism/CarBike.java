...
public class CarBike{
    public static void main(String[] args) {
        ...
        case 2:
            ...
            String n5=s.next();
            c.displayDetails(n1,n2,n3,n4,n5);
            break;
        case 1:
            ...
            String m6=s.next();
            b.displayDetails(m1,m2,m3,m4,m5,m6);
            break;
            default:
...
class Car{
    public void displayDetails(String n1, int n2, int n3, int n4, String n5) {
        ...
        System.out.println("Max Speed   : "+n2);
        System.out.println("No.of Seats : "+n3);
        System.out.println("No.of Wheels: "+n4);
...
class Bike{
    public void displayDetails(String m1, int m2, int m3, int m4, int m5, String m6) {
        ...
        System.out.println("Max Speed   : "+m2);
        System.out.println("No.of Seats : "+m3);
        System.out.println("No.of Wheels: "+m4);
        System.out.println("No.of doors : "+m5);
